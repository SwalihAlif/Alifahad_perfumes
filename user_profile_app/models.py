...
class UserProfile(models.Model):
    user = models.ForeignKey(User, related_name='address_set', on_delete=models.CASCADE, default=None)
    ...
    image_regex = RegexValidator(
    regex=r"^.*\.(jpg|jpeg|png|webp)$",
    message="Image must be a valid file type: .jpg, .jpeg, .png, or .webp"
    )
    image = CloudinaryField('image', validators=[image_regex], blank=True, null=True)
